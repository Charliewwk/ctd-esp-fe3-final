...
const Card = ({ user }) => {
  ...
  return (
    <div className="card bg-light mb-3 position-relative">
      ...
      <span className="favorite position-absolute top-0 end-0 p-1" onClick={handleToggleFavorite}>
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" stroke="red" strokeOpacity="0.1" fill={isFavorite ? "red" : "#ffdede" } className="bi bi-heart-fill" viewBox="0 0 16 16">
      ...
      <div className="card-body">
          <div className="card-text d-flex justify-content-between align-items-center">
            ...
            <span className="emailDecoration">{user.email}</span>
          </div>    
      </div>
    </div>
  );
